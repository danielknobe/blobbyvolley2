...
function decide (funcno)
 ...
 chosen=1
 chosenret=0
 --Alle Funktionen abfragen und die mit dem gr��ten Return w�hlen
...
function estimatex(destY) --gibt m�glichst genaue Angabe der X-Koordinate zur�ck, bei der sich der Ball befindet, wenn er sich bei der angegebenen Y Koordinate befindet
